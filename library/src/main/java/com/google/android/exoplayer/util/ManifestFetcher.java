...
public class ManifestFetcher<T> implements Loader.Callback {
    ...
    public static final String MANIFEST_UNENCRYPTED = "manifest.mpd";
    public static final String MANIFEST_ENCRYPTED = "manifestE.mpd";
    ...
    private class ManifestLoadable implements Loadable {
        ...
        public void load() throws IOException, InterruptedException {
            ...
            try {
                ...
                if(manifestUrl.contains(MANIFEST_ENCRYPTED)){
                    InputStream inputStream1 = new MyInputStream(inputStream);
                    result = parser.parse(inputStream1, inputEncoding, contentId,
        ...
        private class MyInputStream extends InputStream {
            ...
            public void mark(int readlimit) {
                parentInputStream.mark(readlimit);
            }
            ...
            public int read() throws IOException {
                ...
                int result = parentInputStream.read(buffer, 0, 1);
                if(buffer[0] != -128){
            ...
            public int read(byte[] buffer, int byteOffset, int byteCount) throws IOException {
                int bytesRead = parentInputStream.read(buffer, byteOffset, byteCount);
                byte test;
            ...
            public long skip(long byteCount) throws IOException {
                return parentInputStream.skip(byteCount);
            }
